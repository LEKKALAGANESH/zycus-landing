...
- SMTP credentials are configured and a test submission successfully delivers an email to `sales@zycus.landing.com`.
...
| B-06 | Notification email      | Valid submission made | Check `sales@zycus.landing.com` inbox                          | Email arrives within 60 seconds; all 8 fields rendered in body                                | Major    |
...
> UAT sign-off
>
> Approved by: ********\_\_\_******** (Client QA Lead) Date: ******\_******
>
> Approved by: ********\_\_\_******** (Client Marketing Ops) Date: ******\_******
>
> Approved by: ********\_\_\_******** (Vendor Delivery Lead) Date: ******\_******
